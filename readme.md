...
octoplasm (created from eight ghosts) © M
...
decreepit (where old things crawl to die) © M
...
rague (making a raging argument) © M
...
soupstitute (preference for liquid meals) © M
...
risotton (heavy carbohydrate overkill) © M
...
wartch (dermatological attention) © M
...
pregistry (contains facts before they're true) © M
...
slonpoke (impeded by its own size 🐘) [sla] © M
...
frogzen (extremely hybernated) © M
...
broodcast (excessively talkative podcast trying to be profound but really just yapping about) © K
...
monstar (the best of the worst; a luminary of the dark ones) © M
...
boaran (hybrid horned boar) [ru] © M
...
thenks (preliminary gratitude for future actions) © M
...
moonument (made of moon rock, or placed on lunar surface, or depicts a naked butt) © M
...
althornative (painful palliative) © M
...
existence of "satellite" implies existence of "satelheavy" © LJ
...
existence of "colorado" implies existence of "aurado" (where you hear wonderful many noises) © M
...
amplant (amplified implant; implanted amplifier) © LJ
...
harmacy (store that sells poisons only; maybe a regular service for masochists) © LJ
...
acsassory (everyone slags you for it) © M
...
heirarchy (order of inheritance; royal line of succession) © VA
...
app-roach (a REALLY buggy app) © K
...
torchure (using fire to torment someone) © M
...
litteral (absolute garbage; garbage in the sea = littoral) © LJ
...
armoar (chunky, expansive protective gear; never thicc enough) © M
...
frostrating (something that really chills you ❄️) © M
...
disgussion (a conversation with a certain amount of distaste) © M
...
discribe (etch on a discplate) © M
...
turnament (where contestants act one after another) © M
...
foolder (replete with deceitful documents) © M
...
mellowdramatic (when tensions are low) © M
...
cointinue (insert money 🪙 to proceed) © M
...
peeriod (peer approval interval; an observed interval; a time of equals, or perhaps of best among equals) © M
...
preformance (rehearsing; precompilation) © Y
...
betterfly (preferred type of insect, i.e. non-existent) © VA
...
perpetraitor (one against one's own kind) © M
...
dearelict (someone's favorite ruin) © M
...
indoctorinate (persuade by using "doctored" sources) © M

indoctorination (induced belief in medicine) © M
...
beefore (green grass comes before cattle) © M

ballt © M

diesection © M

laytency (going to bed late) © M

boundwidth © M

brandwidth © M

bisquit (pseudo-food, try and instantly nope-out; stops being edible at a certain point) © M
...
evidense (solid proof) © M

evildense © M

evildence © M

availabel (accessibility marker; shows that you can avail yourself of this) © M
...
legth (motive limb measurement) © M
...
carbage (rolling junk; rolling deathtrap) © M

beerd (facial hair soaked in fermented drink) © M

formeat © M

diffstribution © M

absense (merely undetectable; lack of common sense) © M
...
luckluster (left wanting for good fortune) © M
...
trashure (treasure that's trash, or vice versa; the logical conclusion of one man's trash being another man's treasure) © VA
...
storange (unusually roomy; unusually packed) © M
...
floatilla (sits lightly on the water) © M
...
layter (postpone due to lazying in bed) © M
...
castomize (with cast-gold filigrees) © M
...
freequency (unoccupied frequency; a rebel radio station) © VA
...
tailsman (crafts amulets from animal tails) © M

talismain (protects what's most important?) © M
...
wretchribution (maim in revenge) © M
...
itermediate (state between two steps) © Y
...
algorhythm (well-choreographed algorithm; computer-generated music) © M
...
bitterfly (unsavory insect; beautiful but not tasty) © M
...
kingratulations (royal gratitude; royal celebration) © M
...
guarden (very defended; den of guards? tight group of guards?; 🛡️🪴🌻) © M
...
usedful (formerly useful; worn out from overuse) © M
...
fucktion (ability to perform intercourse; dickish faction) © M

suckceptible (gullible) © M

sassinate (take down by talking down; figuratively murder with a pithy burn) © M
...
ooptimal (unexpectedly fitting) © M
...
puriod (time of purification; time of clarity) © M
...
coverment (secretive ruling body) © M
...
iceolated (stranded in a cold place ❄️) © M
...
chilldren (for laissez-faire parents; small ones making your skin crawl) © M
...
graydient (shades of black and white) © M
...
robolution (machine uprising) © M

realaxation (actual rest) © M
...
healium (gas with healing properties; restorative substance; opposite of hurtium) © M

saycret (has been outed away) © M

saycred © M

saygment (someone's turn to speak) © M
...
feetback (feeling the ground with your soles) © M
...
dicktionary (a priapic encyclopedia) © M
...
flayvore (eats skin of its victims, or eats freshly skinned victims) © M
...
dogument (pet passport; proof of pedigree) © M
...
chambeer (dedicated compartment for beer; beer cellar; supersized keg) © M
...
dierection (all the troops die if they march that way) © M

dierect (deadly accurate; last dying order; suicide mission order) © M
...
eyefirmative (signaling agreement with a gaze) © M
...
windter (particularly fierce northern season) © M
...
suspact (collude against someone without proof?) © M
...
octobeer (brewfest month; seasonal drink) © M
...
entitty (the only thing you can focus on) © M
...
untelligence (as dumb as the non-talking animals are) © LJ
...
fatom (heavy atom; understanding slowly dawning in a _thick_ skull) © M
...
teamplate (exemplary team, a template for others; shared with / worked on by the whole team, courtesy of atrocious Kiwi accent) © M
